...
namespace geode {
    ...
    public:
        ...
        bool addDropHandler(Mod* owner, std::string handler_id, std::function<bool(Path)> handler);
        bool addDropHandler(Mod* owner, std::string handler_id, std::function<bool(Path)> handler, std::string extension);
